...
public abstract class BasePreparedStatementTester
{
  ...
  public void testExecuteQuery_String()
  {
    ...
    catch(SQLTimeoutException ste) { Assert.fail(EU.getExceptionMessage(ste)); }
    catch(SQLException se) { Assert.fail(EU.getExceptionMessage(se)); }
  ...
  public void testExecuteUpdate_String()
  {
    ...
    { 
      try { clean(); }
      catch(SQLException se1) { Assert.fail(EU.getExceptionMessage(se1)); }
    }
  } /* testExecuteUpdate */
  ...
  public void testSetUrl()
  {
    ...
    catch(MalformedURLException mue) { Assert.fail(EU.getExceptionMessage(mue)); }
    catch(SQLTimeoutException ste) { Assert.fail(EU.getExceptionMessage(ste)); }
    catch(SQLException se) { Assert.fail(EU.getExceptionMessage(se)); }
  } /* testSetUrl */
